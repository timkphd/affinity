...
## The original script layed out tasks in reverse order.
## that is low numbered tasks go on higher cores.
## To fix this flip the task list around. If the name
## of the program contains "up" like maskup.py then
## it will be done.
###### ln -s maskgenerator.py maskup.py ######
if args[0].find("up") > -1 : ranks.reverse()
masks=[]
randomize=False
